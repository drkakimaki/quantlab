...
def main() -> None:
    ...
    # v13: v06 entry rules + A+ size multiplier at entry
    params = dict(
        entry_2step=True,
        aplus_enabled=True,
        aplus_close_top_frac=0.65,  # top 35%
        aplus_size_mult=1.5,
        allow_pyramid=False,
        long_only=True,
        # keep other feature toggles OFF
    ...
    out_path = out_dir / "v13_aplus_size.html"
    report_periods_equity_only(
        periods={"2022": bt22, "2023-2025": bt23, "2026": bt26},
        out_path=out_path,
        title="XAUUSD breakout_pullb v13_aplus_size",
        freq="5MIN",
        initial_capital=1.0,
        n_trades=n_trades,
    )
