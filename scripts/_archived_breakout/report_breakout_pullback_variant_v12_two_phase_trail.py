...
def main() -> None:
    ...
    # v12: v06 entry + two-phase trailing after +1.0*ATR proof
    params = dict(
        entry_2step=True,
        allow_pyramid=False,
        long_only=True,
        trail_after_atr=1.0,
        trail_style="chandelier_close",
        trail_chand_atr=2.0,
    ...
    out_path = out_dir / "v12_two_phase_trail.html"
    report_periods_equity_only(
        periods={"2022": bt22, "2023-2025": bt23, "2026": bt26},
        out_path=out_path,
        title="XAUUSD breakout_pullb v12_two_phase_trail",
        freq="5MIN",
        initial_capital=1.0,
        n_trades=n_trades,
    )
